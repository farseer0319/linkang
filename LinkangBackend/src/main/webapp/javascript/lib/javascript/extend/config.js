...
define([
 ...
 // config.UPLOAD_URL = "http://10.242.233.55:8098/filemgr/upload";
  ...
  // if(DEBUG){
	 //  config.MAINSITE = 'http://paopao.163.com';
	 //  config.BACKEND = 'http://back.paopao.163.com';
	 //  config.DOMAIN_URL = 'http://cms.paopao.163.com';
  // } else{
	  config.DOMAIN_URL = 'http://cms.paopao.163.com';
	  config.BACKEND = 'http://pis.paopao.163.com';
	  config.MAINSITE = 'http://paopao.163.com';
  // }
  // 默认上传参数
  config.UPLOAD_PARAM = {
