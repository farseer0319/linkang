...
//					}
					...
					this.form.brandProbability.selectedIndex= parseInt(options.data.brandProbability);
				} else{
					this.logos = [];
					this.logos.length = 1;
				}
			...
			pro.__onOKClick = function(event) {
				...
				if (pass&&pass1){
					...
					request('/business/brand/update',{data:formData,method:'PUT',onload:this.__onRequestLoad._$bind(this),onerror:f})
